...
def start_sniffing(interface, filter_exp):
    print(f"[*] Starting DRACO on {interface} with filter '{filter_exp}'...")
...
if __name__ == "__main__":
   ...
   ░▒▓███████▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓██████▓▒░ ░▒▓██████▓▒░       ░▒▓█▓▒░ 
    ...
    """
    print(ascii_art)
    print("DRACO - Packet Sniffing Tool $ MADE BY Hajra ! @scriptkidworld on tiktok \n")
    print("YouTube : ScriptKid Networks | TikTok : @scriptkidworld")
    print("What do you wanna sniff?")
    print("1. All Traffic")
